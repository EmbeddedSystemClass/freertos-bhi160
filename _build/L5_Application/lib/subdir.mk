...
C_SRCS += \
../L5_Application/lib/bhy.c \
../L5_Application/lib/bhy_uc_driver.c 

OBJS += \
./L5_Application/lib/bhy.o \
./L5_Application/lib/bhy_uc_driver.o 

C_DEPS += \
./L5_Application/lib/bhy.d \
./L5_Application/lib/bhy_uc_driver.d 


# Each subdirectory must supply rules for building sources it contributes
L5_Application/lib/%.o: ../L5_Application/lib/%.c
	@echo 'Building file: $<'
